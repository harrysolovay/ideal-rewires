...
var reactAppRewired = require('react-app-rewired');
...
var index = (function (options) {
  return {
    webpack: function webpack(config, env) {
      var babelLoader = reactAppRewired.getBabelLoader(config.module.rules);
